...
public class CharacterManager {
    ...
    public List<SearchResult> findCharacter(String characterString) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        Gson gson = new Gson();
        List<SearchResult> characterResults = new ArrayList<>();
        for (JsonElement e : results) {
            characterResults.add(gson.fromJson(e, SearchResult.class));
        }
